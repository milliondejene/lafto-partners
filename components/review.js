        ...
        <div className="col-lg-12">
          <div className="slider-wrapper">
            <Slider {...settings} className="review-main">
              <div className='col-lg-12'>
                <div className="review-item flex flex-col justify-between px-2 lg:px-4">
                  <div className="comment">
                    <p className="">
                      <i className="fa fa-quote-left text-2xl text-gray-400" aria-hidden="true"></i>
 
Lafto Partners helped us redefine our brand strategy. Their team's creativity and professionalism exceeded our expectations. The impact on our visibility has been phenomenal.
